...
def tracks_router(vibin: Vibin, requires_media, transform_media_server_urls_if_proxying):
    ...
    @router.get("/tracks", summary="", description="", tags=["Tracks"])
    ...
    @router.get("/tracks/lyrics", summary="", description="", tags=["Tracks"])
    ...
    @router.get("/tracks/links", summary="", description="", tags=["Tracks"])
    def track_links(
        artist: Optional[str],
        album: Optional[str],
        title: Optional[str],
    ...
    @router.get("/tracks/{track_id}", summary="", description="", tags=["Tracks"])
    @transform_media_server_urls_if_proxying
    @requires_media
