...
async def async_get_vibin_instance(
    streamer=None,
    streamer_type=None,
    media_server=None,
    ...
    """Return the Vibin singleton instance, using async initialization.

    This is the preferred way to create the Vibin instance in async contexts
    like FastAPI lifespan. Uses async device discovery for better performance.
    """
    global _vibin
