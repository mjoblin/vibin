...
# tracks from different albums. Albums don't seem to come with the artist name
# or genre.
#
...
#   * Fill in an album's Artist and Genre based on the tracks contained in the
#     Album.
